      ...
      setReports([
        {
          ...
          findings: [
            {
              ...
              evidence: ['/evidence/sql-injection-proof.png', '/evidence/database-schema.txt']
            }
          ],
          bountyAmount: 2500,
          currency: 'USD',
          ...
          submissionResponse: 'Report received and is under review'
        },
        {
          id: '2',
          programId: '2',
          ...
          findings: [
            {
              ...
              evidence: ['/evidence/xss-alert.png', '/evidence/payload-details.txt']
            }
          ],
          bountyAmount: 1500,
          currency: 'USD',
          ...
          submittedBy: 'security_analyst',
          reportUrl: 'https://bugcrowd.com/submissions/789012',
          submissionResponse: 'Vulnerability confirmed and bounty awarded'
        },
        {
          id: '3',
          programId: '3',
          ...
          findings: [
            {
              ...
              evidence: ['/evidence/ssl-scan-results.txt']
            }
          ],
          currency: 'EUR',
          ...
          findings: [
            {
              ...
              evidence: ['/evidence/headers-disclosure.txt']
            }
          ],
          currency: 'EUR',
        ...
        },
        {
          ...
          findings: [
            {
              ...
              severity: 'high',
              description: 'IDOR vulnerability allowing access to other user profiles',
              evidence: ['/evidence/idor-proof.png']
            }
          ],
          currency: 'USD',
          ...
          submittedBy: 'security_analyst',
          reportUrl: 'https://hackerone.com/reports/234567',
          submissionResponse: 'Duplicate report - already reported by another researcher'
        }
      ]);
    }, 1000);
  };
