      ...
      setJobs([
        {
          ...
          logs: [
            { timestamp: new Date(Date.now() - 1800000).toISOString(), level: 'info', message: 'Starting reconnaissance scan for *.techcorp.com' },
            { timestamp: new Date(Date.now() - 1500000).toISOString(), level: 'info', message: 'Discovered 47 subdomains using amass' },
            { timestamp: new Date(Date.now() - 1200000).toISOString(), level: 'info', message: 'Found 23 open ports using naabu' },
            { timestamp: new Date(Date.now() - 900000).toISOString(), level: 'warning', message: 'Some subdomains are not responding to HTTP requests' },
            { timestamp: new Date(Date.now() - 600000).toISOString(), level: 'info', message: 'Identified 15 technologies using wappalyzer' }
          ]
        },
        {
          id: '2',
          ...
          logs: [
            { timestamp: new Date(Date.now() - 7200000).toISOString(), level: 'info', message: 'Starting reconnaissance scan for *.financeapp.com' },
            { timestamp: new Date(Date.now() - 6600000).toISOString(), level: 'info', message: 'Discovered 23 subdomains' },
            { timestamp: new Date(Date.now() - 6000000).toISOString(), level: 'info', message: 'Found 12 open ports' },
            { timestamp: new Date(Date.now() - 5400000).toISOString(), level: 'info', message: 'Identified 8 technologies' },
            { timestamp: new Date(Date.now() - 3600000).toISOString(), level: 'info', message: 'Reconnaissance scan completed successfully' }
          ]
        },
        {
          id: '3',
          ...
          logs: [
            { timestamp: new Date(Date.now() - 900000).toISOString(), level: 'info', message: 'Starting reconnaissance scan for *.ecommerce.com' },
            { timestamp: new Date(Date.now() - 750000).toISOString(), level: 'error', message: 'Network timeout while connecting to target domain' },
            { timestamp: new Date(Date.now() - 600000).toISOString(), level: 'error', message: 'Reconnaissance scan failed' }
          ]
        }
      ]);
    }, 1000);
